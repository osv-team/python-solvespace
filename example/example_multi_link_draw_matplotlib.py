...
# Multi-linkage Point7 Path Graphics
# The active axis is [Crank] Point1-Point2
# Graphics will be explained in the program
...
def multi_link(degree):
    ...
    # [Crank]Point1-Point2 Length 15mm
    ...
    # The first group of [dead] Point3-Point4-Point5 (Point3 fixed)
    # 長度41.5-55.8-40.1mm
    # Length 41.5-55.8-40.1mm
    ...
    # The second group [dead] Point6-Point7-Point8
    # 長度65.7-49.0-36.7mm
    # Length 65.7-49.0-36.7mm
    ...
    # Two links [Stay chain - Stay chain] connecting rod
    # Point5-Point6 Length 39.4mm
    # Point3-Point8 Length 39.3mm
    ...
    # Two sections [area handle-dummy] connecting rod
    # Point2-Point4 Length 50.0mm
    # Point2-Point8 is 61.9mm long
    Constraint.distance(50.0, Workplane1, Point2, Point4)
    Constraint.distance(61.9, Workplane1, Point2, Point8)

    # 水平輔助Line0
    # Horizontal Auxiliary Line 0
    ...
    # 區柄角度（手動項目務必放最後）
    # Handle angle (manual item must be placed last)
...
for i in range(0, 361, 1):
    ...
    if t is not None:
        ...
        # TODO : Happens at 180 deg - why?
        msg = "multi_link(%i) returned None" % i
        print(msg)
        # raise AssertionError("multi_link(%i) returned None" % i)
